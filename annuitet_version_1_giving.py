...
driver.get("http://localhost:65009/Reception/Client/Details/24507")
...
give_loan_btn.click()
give_loan_usual_btn = driver.find_element(By.CSS_SELECTOR, 'a[href="/Reception/Loan/Create/24507"]')
...
add_tariff = driver.find_element(By.XPATH, "//option[@value='3091']")
add_tariff.click()
